(() => {
  ...
  var Te = class {
    ...
    on(s, e, t = null) {
      ...
      if (t) {
        const r = this.__hooks__[s].findIndex(
  ...
  var Ne = class extends f {
    ...
    handleCheckboxChange(e, t, r) {
      ...
      if (a.length === 0) {
        ...
        const l = {};
        for (const [o, c] of Object.entries(this.selectedFilters))
          l[o] = Array.from(c);
