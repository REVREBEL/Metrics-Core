(() => {
  ...
  function _e(l, e, t) {
    ...
    s && s.m(e, t),
      Ae(() => {
        const r = l.$$.on_mount.map(Bt).filter(ut);
          ...
          const s = () => {
            ...
            for (const a in this.$$p_d)
              if (
                ...
                const r = Xt(a, this.$$d[a], this.$$p_d, "toAttribute");
                r == null
  ...
  var mt = class {
    constructor(e) {
      ...
      delete e.element,
        ...
        delete e.sort;
      const U = t instanceof HTMLElement ? t : document.querySelector(t);
      U
        ? (this._pfs = new ks({
            target: U,
            props: {
    ...
    triggerFilters(e) {
      ...
      for (const [s, a] of Object.entries(e))
        if (Array.isArray(a)) for (const r of a) t[`${s}:${r}`] = !0;
        else t[`${s}:${a}`] = !0;
