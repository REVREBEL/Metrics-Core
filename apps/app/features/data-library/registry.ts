...
export const dataLibraryTableRegistry: readonly DataLibraryTableDefinition[] = [
  {
    key: "metrics_core.lkp_segment_group",
    dataset: "metrics_core",
    table: "lkp_segment_group",
    category: "lookup",
    group: "Segments",
    title: "Segment groups",
    description:
      "Controlled commercial segment groups used by the segment mapping workflow.",
    grain: "One row per standard commercial segment group code.",
    primaryKey: ["code"],
    defaultSort: {
      column: "sort",
      direction: "asc",
    ...
    columns: [
      {
        ...
        editable: false,
        required: true,
        description: "Stable standard commercial segment group code.",
        searchable: true,
        sortable: true,
        filterable: true,
        visible: true,
      },
      {
        ...
        editable: true,
        required: true,
        description: "Segment group display name.",
        searchable: true,
        sortable: true,
        filterable: false,
        visible: true,
      },
      {
        ...
        editable: true,
        required: false,
        description: "Definition or usage notes for the segment group.",
        searchable: true,
        sortable: true,
        filterable: false,
        visible: true,
      ...
      },
      {
        ...
        editable: true,
        required: true,
        description: "Whether the segment group is active.",
        searchable: false,
        sortable: true,
        filterable: true,
        visible: true,
  ...
  {
    key: "metrics_core.lkp_finance_segment",
    dataset: "metrics_core",
    table: "lkp_finance_segment",
    category: "lookup",
    group: "Segments",
    title: "Finance segments",
    description:
      "Controlled finance segment values used by the segment mapping workflow.",
    grain: "One row per standard finance segment code.",
    primaryKey: ["code"],
    defaultSort: {
      column: "sort",
      direction: "asc",
    ...
    columns: [
      {
        ...
        editable: false,
        required: true,
        description: "Stable standard finance segment code.",
        searchable: true,
        sortable: true,
        filterable: true,
        visible: true,
      },
      {
        ...
        editable: true,
        required: true,
        description: "Finance segment display name.",
        searchable: true,
        sortable: true,
        filterable: false,
        visible: true,
      },
      {
        ...
        editable: true,
        required: false,
        description: "Definition or usage notes for the finance segment.",
        searchable: true,
        sortable: true,
        filterable: false,
        visible: true,
      ...
      },
      {
        ...
        editable: true,
        required: true,
        description: "Whether the finance segment is active.",
        searchable: false,
        sortable: true,
        filterable: true,
        visible: true,
  ...
  {
    key: "metrics_core.lkp_source",
    dataset: "metrics_core",
    table: "lkp_source",
    category: "lookup",
    group: "Sources and Channels",
    title: "Sources",
    description:
      "Controlled source values used by the source mapping workflow.",
    grain: "One row per standard source code.",
    primaryKey: ["code"],
    defaultSort: {
      column: "sort",
      direction: "asc",
    ...
    columns: [
      {
        ...
        editable: false,
        required: true,
        description: "Stable standard source code.",
        searchable: true,
        sortable: true,
        filterable: true,
        visible: true,
      ...
      },
      {
        ...
        editable: true,
        required: false,
        description: "Definition or usage notes for the source.",
        searchable: true,
        sortable: true,
        filterable: false,
        visible: true,
      ...
      },
      {
        ...
        editable: true,
        required: false,
        description: "Optional broader source family or legacy label.",
        searchable: true,
        sortable: true,
        filterable: true,
        visible: true,
  ...
  {
    key: "metrics_core.lkp_subsource",
    dataset: "metrics_core",
    table: "lkp_subsource",
    category: "lookup",
    group: "Sources and Channels",
    title: "Subsources",
    description:
      "Controlled subsource values used by the source mapping workflow.",
    grain: "One row per standard subsource code.",
    primaryKey: ["code"],
    defaultSort: {
      column: "sort",
      direction: "asc",
    ...
    columns: [
      {
        ...
        editable: false,
        required: true,
        description: "Stable standard subsource code.",
        searchable: true,
        sortable: true,
        filterable: true,
        visible: true,
      },
      {
        ...
        editable: true,
        required: true,
        description: "Subsource display name.",
        searchable: true,
        sortable: true,
        filterable: false,
        visible: true,
      },
      {
        ...
        editable: true,
        required: false,
        description: "Definition or usage notes for the subsource.",
        searchable: true,
        sortable: true,
        filterable: false,
        visible: true,
      ...
      },
      {
        ...
        editable: true,
        required: true,
        lookupDependency: "metrics_core.lkp_source",
        description: "Parent standard source code.",
        searchable: true,
        sortable: true,
        filterable: true,
        visible: true,
      },
      {
        ...
        editable: true,
        required: true,
        description: "Whether the subsource is active.",
        searchable: false,
        sortable: true,
        filterable: true,
        visible: true,
  ...
  {
    key: "metrics_core.lkp_channel_group",
    dataset: "metrics_core",
    table: "lkp_channel_group",
    category: "lookup",
    group: "Sources and Channels",
    title: "Channel groups",
    description:
      "Controlled channel groups used by the source mapping workflow.",
    grain: "One row per standard channel group code.",
    primaryKey: ["code"],
    defaultSort: {
      column: "sort",
      direction: "asc",
    ...
    columns: [
      {
        ...
        editable: false,
        required: true,
        description: "Stable standard channel group code.",
        searchable: true,
        sortable: true,
        filterable: true,
        visible: true,
      },
      {
        ...
        editable: true,
        required: true,
        description: "Channel group display name.",
        searchable: true,
        sortable: true,
        filterable: false,
        visible: true,
      },
      {
        ...
        editable: true,
        required: false,
        description: "Definition or usage notes for the channel group.",
        searchable: true,
        sortable: true,
        filterable: false,
        visible: true,
      ...
      },
      {
        ...
        editable: true,
        required: true,
        description: "Whether the channel group is active.",
        searchable: false,
        sortable: true,
        filterable: true,
        visible: true,
