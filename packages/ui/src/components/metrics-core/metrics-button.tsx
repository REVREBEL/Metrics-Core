    ...
    variants: {
      variant: {
        default: [
          ...
          "active:[background-color:color-mix(in_srgb,var(--button-color-inverse)_80%,transparent)]",
        ].join(" "),
        monocolor: [
          "[background-color:var(--button-color)]",
          "[color:var(--button-color-inverse)]",
          "shadow-xs",
          "hover:[background-color:color-mix(in_srgb,var(--button-color)_80%,transparent)]",
          "hover:[color:var(--button-color-inverse)]",
          "active:[background-color:color-mix(in_srgb,var(--button-color)_95%,black)]",
          "active:[color:var(--button-color-inverse)]",
        ].join(" "),
        outline: [
          "border-solid",
