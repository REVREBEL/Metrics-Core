...
export function LayoutProvider({ children }: LayoutProviderProps) {
  ...
  // Optimized: Memoize the setCollapsible function to prevent unnecessary re-renders of consumer components
  ...
  // Optimized: Memoize the setVariant function to prevent unnecessary re-renders of consumer components
  const setVariant = useCallback((newVariant: Variant) => {
    _setVariant(newVariant);
    setCookie(LAYOUT_VARIANT_COOKIE_NAME, newVariant, LAYOUT_COOKIE_MAX_AGE);
  }, []);

  // Optimized: Memoize the resetLayout function to prevent unnecessary re-renders of consumer components
