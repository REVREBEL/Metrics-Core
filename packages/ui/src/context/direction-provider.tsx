...
export function DirectionProvider({ children }: { children: React.ReactNode }) {
  ...
  // Optimized: Memoize the setDir function to prevent unnecessary re-renders of consumer components
  const setDir = useCallback((dir: Direction) => {
    _setDir(dir);
    setCookie(DIRECTION_COOKIE_NAME, dir, DIRECTION_COOKIE_MAX_AGE);
  }, []);

  // Optimized: Memoize the resetDir function to prevent unnecessary re-renders of consumer components
