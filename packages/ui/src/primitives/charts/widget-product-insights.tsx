...
const DEFAULT_PRODUCT_IMAGE =
  'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="82" height="82" viewBox="0 0 82 82" fill="none"><rect width="82" height="82" rx="8" fill="%23F3F4F6"/><rect x="21" y="21" width="40" height="40" rx="6" fill="%236366F1" fill-opacity="0.1"/><path d="M41 31L51 48H31L41 31Z" fill="%236366F1"/><circle cx="41" cy="38" r="4" fill="%23FFF"/></svg>';
