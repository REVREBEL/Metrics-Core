...
const DEFAULT_COMPANY_LOGO =
  'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" viewBox="0 0 42 42" fill="none"><rect width="42" height="42" rx="8" fill="%234F46E5"/><circle cx="21" cy="21" r="10" fill="%23FFF" fill-opacity="0.2"/><circle cx="21" cy="21" r="6" fill="%23FFF"/></svg>';
...
const SalesMetricsCard = ({
  ...
  // Sales chart data
  // ⚡ Bolt: Memoize chart data and move expensive date formatting outside the loop
