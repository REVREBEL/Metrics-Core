...
const formatActions: InsertElement[] = [
  {
    ...
    action: (editor: Editor) => (editor.chain().focus() as any).toggleCodeBlock().run(),
  ...
  },
  {
    ...
    action: (editor: Editor) => (editor.chain().focus() as any).toggleBlockquote().run(),
  ...
  },
  {
    ...
    action: (editor: Editor) => (editor.chain().focus() as any).setHorizontalRule().run(),
    isActive: () => false,
    canExecute: (editor: Editor) =>
